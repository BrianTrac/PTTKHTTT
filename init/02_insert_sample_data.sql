...
(N'Bệnh nặng không thể tham gia thi theo lịch đã đăng ký', 'https://res.cloudinary.com/dvzhmi7a9/image/upload/v1752205277/giay-chung-nhan-benh_gmbnm5.png', 200000.00, 0, '2025-09-12', 'Da_duyet', 12, 1, 1),
(N'Công tác đột xuất của công ty không thể sắp xếp lại', 'https://res.cloudinary.com/dvzhmi7a9/image/upload/v1752205275/lenh-cong-tac_u6ywx4.png', 150000.00, 0, '2025-10-03', 'Da_duyet', 15, 1, 2),
